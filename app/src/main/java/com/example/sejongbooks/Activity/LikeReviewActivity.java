...
import com.example.sejongbooks.Singleton.LikeReviewManager;
...
public class LikeReviewActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        m_url = "http://15011066.iptime.org:7000/review/mylike/";
    ...
    private void initView(){
        txtNull = findViewById(R.id.txt_null_like_review);
    ...
    public class CheckTypesTask extends AsyncTask<Void, Void, Void> {
        ...
        ProgressDialog asyncDialog = new ProgressDialog(LikeReviewActivity.this, R.style.progress_bar_style);
